        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <ul class="list-group">
                    ...
                    <?=in_array('early_bronze', $petroglyph->epoch)?'<li class="list-group-item">' . lang("early_bronze_epoch") . '</li>':''?>
                    <?=in_array('middle_bronze', $petroglyph->epoch)?'<li class="list-group-item">' . lang("middle_bronze_epoch") . '</li>':''?>
                    <?=in_array('late_bronze', $petroglyph->epoch)?'<li class="list-group-item">' . lang("late_bronze_epoch") . '</li>':''?>
                    ...
                    <?=in_array('middle_iron', $petroglyph->epoch)?'<li class="list-group-item">' . lang("middle_iron_age") . '</li>':''?>
                    <?=in_array('late_iron', $petroglyph->epoch)?'<li class="list-group-item">' . lang("late_iron_age") . '</li>':''?>
                    <?=in_array('iron', $petroglyph->epoch)?'<li class="list-group-item">' . lang("iron_age") . '</li>':''?>
                    ...
                    <?=in_array('ethnographic', $petroglyph->epoch)?'<li class="list-group-item">' . lang("ethnographic_period") . '</li>':''?>

                </ul>
            </div>
        </div>
    <?php endif;?>
    <?php if ($petroglyph->method != [""]):?>
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">
